...
\
\
а#Ruby-Text.tip(wrapper: "[ * ]", anno-wrapper: none, wrap-anno-parts: true)[諸|具][Shō|Gun]а \ \
а[#Ruby-Text.furigana[諸|具][Shōasfasfsfaf|Gunфыаыфа]]а \ \
а#Ruby-Text.furigana(wrapper: "[ * ]")[諸|具][Shōasfasfsfaf|Gunфыаыфа]а \ \
а#Ruby-Text.furigana[諸|具][Shōafffff|Gun]а \ \
\
\
